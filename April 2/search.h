...
class Search {
public:
    constexpr bool USE_TWIST_FLIP_PRUN = true;
...
private:
     ...
     */
    constexpr int EXTRA_PRUN_LEVEL = 0;

    constexpr bool USF_FULL_PRUN = false;
    constexpr bool USF_HUGE_PRUN = false;

    //Options for research purpose.
    constexpr bool TRY_PRE_MOVE = true;
    constexpr bool TRY_INVERSE = true;
    constexpr bool TRY_THREE_AXES = true;

    constexpr int MAX_DEPTH2 = 13;
